String[] Colors = {"Cherry", "Cotton Candy", "Flare", "Flower", "Gold", "Grayscale", "Royal", "Sky", "Vine", "Red", "Blue"};
int inAirTicks; 
...
Color[] getGradientColors(int mode) {
    switch (mode) {
        ...
        case 9: return new Color[]{new Color(255, 0, 0), new Color(170, 20, 20)};
        case 10: return new Color[]{new Color(0, 0, 255), new Color(50, 50, 170)};
